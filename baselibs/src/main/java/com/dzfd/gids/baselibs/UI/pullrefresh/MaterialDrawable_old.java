 ...
 * @hide
 */
class MaterialDrawable_old extends RefreshDrawable implements Animatable {
...
//    @Retention(RetentionPolicy.CLASS)
    ...
    public MaterialDrawable_old(Context context, BunRefreshLayout parent) {
...
//        ViewCompat.setLayerType(this, ViewCompat.LAYER_TYPE_SOFTWARE, circle.getPaint());
    ...
    private class OvalShadow extends OvalShape {
        ...
        public void draw(Canvas canvas, Paint paint) {
            final int x = MaterialDrawable_old.this.getBounds().centerX();
            final int y = MaterialDrawable_old.this.getBounds().centerY();
    ...
    private void setupAnimators() {
        ...
        finishRingAnimation.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
                ...
                //避免在stop的时候clear这个animation会导致onAnimationEnd执行 最后会导致刷新结束而会新开启mAnimation
                if (isRefreshing){
                    mParent.startAnimation(mAnimation);
                }
            }
