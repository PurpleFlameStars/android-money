...
public class ReflectUtils {
    ...
    public static String getSystemProperties(String propertyName, String defaultValue) {
        ...
        } catch (ClassNotFoundException | SecurityException | IllegalArgumentException | NoSuchMethodException | IllegalAccessException | InvocationTargetException e) {                e.printStackTrace();
            e.printStackTrace();
