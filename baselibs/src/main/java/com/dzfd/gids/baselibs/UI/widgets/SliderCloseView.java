...
public class SliderCloseView extends RelativeLayout {
...
//    private float mLastDownX;
	...
	private SubViewTouchListener _Subview;
	...
	public void SetSubViewMoveListener(SubViewTouchListener listener){
		_Subview=listener;
	}
	protected void SetSliderview(View view){
		mSliderView = view;
		if(mSliderView!=null){
			mSliderView.setClickable(true);
		}
	}
...
//                mLastDownX = mInitDownX;
			...
			case MotionEvent.ACTION_MOVE:{
				if(_Subview!=null && _Subview.SubViewIsMoveing()){
					return super.onInterceptTouchEvent(ev);
				}
...
//                mLastDownX = 0;
	...
	public interface SubViewTouchListener{
		boolean SubViewIsMoveing();
	}
}