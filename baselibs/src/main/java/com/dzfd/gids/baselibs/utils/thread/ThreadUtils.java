...
public class ThreadUtils {
    ...
    public static class ProxyedAsyncRejectedHandler implements AndroidUtilsCompat.AsynctaskRejectedExecutionHandler {
        @Override
        public Object getExtraInfo(Object task) {
            if (task != null && task instanceof AsyncTask) {
                try{
                    Object postRunnable = ReflectUtils.getFieldValue(task, "mPostRunnable");
                    if (postRunnable != null) {
                        return AndroidUtilsCompat.getOuterClass(postRunnable);
                    }
