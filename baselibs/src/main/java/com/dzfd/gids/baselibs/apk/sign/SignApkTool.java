package com.dzfd.gids.baselibs.apk.sign;

import com.dzfd.gids.baselibs.apk.sign.ApkSignerV2.ApkParseException;
...
/**
 * Created by xupengpai on 2018/5/11.
 */
...
public class SignApkTool {
    ...
    /**
     * @param inputApk 读取apk中签名块中的渠道号信息
     */
    public String readChanael(ByteBuffer inputApk) {
        if (inputApk == null) {
    ...
    public byte[] getAfterWriteChanaelSignatureBlock(byte[] v2SchemeBlockBytes, String chanael) throws ApkSignerV2.ApkParseException {
