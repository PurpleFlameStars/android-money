...
public class LogUtils {
    ...
    public static String getLogPath() {
        return Environment.getExternalStorageDirectory() + "/hotLog";
    }

    // debug 表示是否输出ddms日志。
    // loable 表示是否写日志。
    /*public static void initInAppProcess(boolean debug, boolean logable) {
        isDebug.set(debug);
        isWriteLogFile.set(logable);
        initilized.set(logable);
        canLog.set(logable);
    }*/

    public static void init(final Context context) {
        /*延迟初始化*/
        LogPath = new File(getLogPath() + "/golemon_log.txt");
...
//            ToastUtil.showLong(ContextUtils.getApplicationContext(), "safeCheck:" + getThreadInfo());
        }
    }
...
//            ToastUtil.showLong(ContextUtils.getApplicationContext(), "safeCheck:" + getThreadInfo() + " " + log);
        }
    }
    ...
    public static void safeCheckNotUIThread(String log) {
        if (LogUtils.isDebug() && ThreadUtils.getCurThreadId() == ThreadUtils.getMainThreadId()) {
            ...
            throw new RuntimeException("com.golemon.wegoo assert " + getThreadInfo() + " " + log);
        }
    }

    public static void safeCheckStatParam(boolean bval, String url) {
        if (!bval && LogUtils.isDebug()) {
            throw new RuntimeException("com.golemon.wegoo stat url curpage == null, url =" + url);
        }
    }
    ...
    public static void debug(String tag, String msg) {
        e(tag, ProcessUtils.getCurrentProcessName() + " - " + msg);
    }
