...
import com.dzfd.gids.baselibs.utils.DisplayUtils;
...
public class HorizontalProgressView extends ProgressBar {
    ...
    private int mNormalBarSize = DisplayUtils.dp2px(2);
    private int mNormalBarColor = Color.parseColor("#FFD3D6DA");
    private int mReachBarSize = DisplayUtils.dp2px(2);
    ...
    private int mTextOffset = DisplayUtils.dp2px(6);
    ...
    public void setNormalBarSize(int normalBarSize) {
        mNormalBarSize = DisplayUtils.dp2px(normalBarSize);
        invalidate();
    }
    ...
    public void setReachBarSize(int reachBarSize) {
        mReachBarSize = DisplayUtils.dp2px(reachBarSize);
        invalidate();
    }
    ...
    public void setTextSize(int textSize) {
        mTextSize = DisplayUtils.sp2px(textSize);
        invalidate();
    }
    ...
    public void setTextOffset(int textOffset) {
        mTextOffset = DisplayUtils.dp2px(textOffset);
        invalidate();
    }
